...
window.wm_title("FLIGHT NUMBER: B767 PASSENGER DATABASE")
window.resizable(0,0)

l1=Label(window, text="Passenger Name::", bg="black", foreground='white')
l1.grid(row=0, column=0)

l2=Label(window, text="Class:", bg="black", foreground='white')
l2.grid(row=0, column=3)

l3=Label(window, text="Cost:", bg="black", foreground='white')
l3.grid(row=1, column=0)

l4=Label(window, text="Seat:", bg="black", foreground='white')
...
statusbar = Label(window, text="AIR DECCAN®", bg="black", foreground='white', anchor=W)
